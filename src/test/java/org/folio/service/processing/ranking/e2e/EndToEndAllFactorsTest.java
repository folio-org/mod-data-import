...
public class EndToEndAllFactorsTest extends AbstractEndToEndRankingTest {
  ...
  @SuppressWarnings({"checkstyle:MethodLength", "checkstyle:AbbreviationAsWordInName"})
  protected void initializeData() {
    // new jobs from different tenants, otherwise equal
    final var itemASize100Age0 = item("a", 100, 0, 1);
    final var itemASize1000Age15Part1 = item("a", 1000, 15, 1);
    final var itemASize1000Age15Part2 = item("a", 1000, 15, 2);
    final var itemASize2000Age120 = item("a", 2000, 120, 2);

    final var itemBSize100Age0 = item("b", 100, 0, 1);
    final var itemBSize1000Age15Part1 = item("b", 1000, 15, 1);
    final var itemBSize1000Age15Part2 = item("b", 1000, 15, 2);
    final var itemBSize2000Age120 = item("b", 2000, 120, 2);

    final var itemCSize100Age0 = item("c", 100, 0, 1);
    final var itemCSize1000Age15Part1 = item("c", 1000, 15, 1);
    final var itemCSize1000Age15Part2 = item("c", 1000, 15, 2);
    final var itemCSize2000Age120 = item("c", 2000, 120, 2);

    final var itemDSize100Age0 = item("d", 100, 0, 1);
    final var itemDSize1000Age15Part1 = item("d", 1000, 15, 1);
    final var itemDSize1000Age15Part2 = item("d", 1000, 15, 2);
    final var itemDSize2000Age120 = item("d", 2000, 120, 2);
