...
public class FileSplitUtilitiesChunkKeyTest {
  ...
  public static Collection<Object[]> getCases() {
    return Arrays.asList(
        ...
        new Object[] { "a/really.long/and_..complex.path", 15, "a/really.long/and_..complex_15.path" },
  ...
  public FileSplitUtilitiesChunkKeyTest(String key, int partNumber, String expected) {
    this.key = key;
