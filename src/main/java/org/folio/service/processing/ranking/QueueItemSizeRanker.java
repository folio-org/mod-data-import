...
public class QueueItemSizeRanker implements QueueItemRanker {
  ...
  private final int scoreSmallest;
  private final int scoreLargest;
  private final int scoreLargeReference;

  @Autowired
  public QueueItemSizeRanker(@Value("${SCORE_JOB_SMALLEST:40}") int scoreSmallest,
