...
public abstract class SplitFileProcessingServiceAbstractTest extends AbstractRestTest {

  protected static final String PARENT_UPLOAD_DEFINITION_ID = "parent-upload-definition-id";
  ...
  protected static final String PARENT_JOB_EXECUTION_ID = "parent-job-execution-id";
  ...
  protected static final FileDefinition FILE_DEFINITION_1 = new FileDefinition()
    .withName("file-1").withSourcePath("key/file-1-key");
  protected static final FileDefinition FILE_DEFINITION_2 = new FileDefinition()
    .withName("file-2").withSourcePath("key/file-2-key");
  protected static final FileDefinition FILE_DEFINITION_3 = new FileDefinition()
    .withName("file-3").withSourcePath("key/file-3-key");

  protected static final JobExecution JOB_EXECUTION_1 = new JobExecution()
    .withId("c90e2023-0668-55f9-beba-0d42f7ee3e18").withSourcePath("key/file-1-key");
  protected static final JobExecution JOB_EXECUTION_2 = new JobExecution()
    .withId("30da2d31-eca8-578d-b5e6-ceba28469085").withSourcePath("key/file-2-key");
  protected static final JobExecution JOB_EXECUTION_3 = new JobExecution()
    .withId("3c4add55-cb78-5056-860f-5df0d1aa83ca").withSourcePath("key/file-3-key");
  ...
  protected class SplitFileProcessingServiceProxy extends SplitFileProcessingService {
    ...
    public SplitFileProcessingServiceProxy(
      ...
      super(vertx, fileSplitService, minioStorageService, queueItemDao, uploadDefinitionService, fileProcessor);
    }
